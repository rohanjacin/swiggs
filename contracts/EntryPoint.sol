...
contract EntryPoint is IEntryPoint, StakeManager, NonceManager, ReentrancyGuard, ERC165 {
    ...
    (uint256 collected) {
        ...
        bool success;
        {
            ...
            {
                console.log("before innerHandleOp");
        ...
        if (!success) {
            ...
            if (innerRevertCode == INNER_OUT_OF_GAS) {
                ...
                console.log("INNER_REVERT_LOW_PREFUND");
                ...
                uint256 actualGas = preGas - gasleft() + opInfo.preOpGas;
                console.log("aactualGas:", actualGas);
                ...
                console.log("aaactualGas:", actualGas);
            }
        }
    }
    ...
    function innerHandleOp(
        ...
        console.log("innerHandleOp1.1");
        IPaymaster.PostOpMode mode = IPaymaster.PostOpMode.opSucceeded;
        if (callData.length > 0) {
            console.log("before exec call:", mUserOp.sender);
    ...
    function _validatePaymasterPrepayment(
        ...
        unchecked {
            ...
            console.log("pmVerificationGasLimit:", pmVerificationGasLimit);
        ...
        returns (uint256 validationData, uint256 paymasterValidationData)
    {
        ...
        //console.log("userOpHash:", outOpInfo.userOpHash);
    ...
    function _postExecution(
        ...
        unchecked {
            ...
            if (paymaster == address(0)) {
                ...
                console.log("paymaster!0:", paymaster);
                refundAddress = paymaster;
                if (context.length > 0) {
                    actualGasCost = actualGas * gasPrice;
                    console.log("actualGasCost:",actualGasCost);

                    console.log("mode:", (mode != IPaymaster.PostOpMode.postOpReverted));
                    if (mode != IPaymaster.PostOpMode.postOpReverted) {
                        console.log("paymasterPostOpGasLimit:", mUserOp.paymasterPostOpGasLimit);
                        try IPaymaster(paymaster).postOp{
                            gas: mUserOp.paymasterPostOpGasLimit
                        }(mode, context, actualGasCost, gasPrice)
                        // solhint-disable-next-line no-empty-blocks
                        {} catch {
                            console.log("reverteddd");
            ...
            actualGasCost = actualGas * gasPrice;
            console.log("1.7 actualGasCost:", actualGasCost);
